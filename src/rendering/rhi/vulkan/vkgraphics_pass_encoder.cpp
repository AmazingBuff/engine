...
VKGraphicsPassEncoder::VKGraphicsPassEncoder(VKCommandBuffer const* command)
{
...
{
    VKCommandBuffer const* vk_command_buffer = static_cast<VKCommandBuffer const*>(m_ref_command_buffer);
    VKCommandPool const* vk_command_pool = static_cast<VKCommandPool const*>(vk_command_buffer->m_ref_pool);
    ...
    vk_device->m_device_table.vkCmdBindDescriptorSets(vk_command_buffer->m_command_buffer, VK_PIPELINE_BIND_POINT_GRAPHICS,
...
void VKGraphicsPassEncoder::bind_index_buffer(GPUBufferBinding const& binding)
{
    ...
    vk_device->m_device_table.vkCmdBindIndexBuffer(vk_command_buffer->m_command_buffer, buffer->m_buffer, binding.offset, index_type);
}
...
void VKGraphicsPassEncoder::bind_pipeline(GPUGraphicsPipeline const* pipeline)
{
    ...
    vk_device->m_device_table.vkCmdBindPipeline(vk_command_buffer->m_command_buffer, VK_PIPELINE_BIND_POINT_GRAPHICS, vk_graphics_pipeline->m_pipeline);
}
...
void VKGraphicsPassEncoder::bind_vertex_buffers(GPUBufferBinding const* bindings, uint32_t binding_count)
{
    ...
    vk_device->m_device_table.vkCmdBindVertexBuffers(vk_command_buffer->m_command_buffer, 0, buffer_count, vertex_buffers, offsets);
}
...
void VKGraphicsPassEncoder::draw(uint32_t vertex_count, uint32_t first_vertex)
{
    ...
    VKQueue const* vk_queue = static_cast<VKQueue const*>(vk_command_pool->m_ref_queue);
    VKDevice const* vk_device = static_cast<VKDevice const*>(vk_queue->m_ref_device);
    vk_device->m_device_table.vkCmdDraw(vk_command_buffer->m_command_buffer, vertex_count, 1, first_vertex, 0);
}
...
void VKGraphicsPassEncoder::draw_indexed(uint32_t index_count, uint32_t first_index, uint32_t first_vertex)
{
    ...
    VKQueue const* vk_queue = static_cast<VKQueue const*>(vk_command_pool->m_ref_queue);
    VKDevice const* vk_device = static_cast<VKDevice const*>(vk_queue->m_ref_device);
    vk_device->m_device_table.vkCmdDrawIndexed(vk_command_buffer->m_command_buffer, index_count, 1, first_index, first_vertex, 0);
}
...
void VKGraphicsPassEncoder::draw_indexed_instance(uint32_t index_count, uint32_t instance_count, uint32_t first_index, uint32_t first_vertex, uint32_t first_instance)
{
    ...
    VKQueue const* vk_queue = static_cast<VKQueue const*>(vk_command_pool->m_ref_queue);
    VKDevice const* vk_device = static_cast<VKDevice const*>(vk_queue->m_ref_device);
    vk_device->m_device_table.vkCmdDrawIndexed(vk_command_buffer->m_command_buffer, index_count, instance_count, first_index, first_vertex, first_instance);
}
...
void VKGraphicsPassEncoder::draw_instance(uint32_t vertex_count, uint32_t instance_count, uint32_t first_vertex, uint32_t first_instance)
{
    ...
    VKQueue const* vk_queue = static_cast<VKQueue const*>(vk_command_pool->m_ref_queue);
    VKDevice const* vk_device = static_cast<VKDevice const*>(vk_queue->m_ref_device);
    vk_device->m_device_table.vkCmdDraw(vk_command_buffer->m_command_buffer, vertex_count, instance_count, first_vertex, first_instance);
}
...
void VKGraphicsPassEncoder::set_push_constant(GPURootSignature const* root_signature, String const& name, void const* data)
{
    ...
    for (uint32_t i = 0; i < vk_root_signature->m_push_constant_count; i++)
    {
        ...
        {
            vk_device->m_device_table.vkCmdPushConstants(vk_command_buffer->m_command_buffer, vk_root_signature->m_pipeline_layout,
...
void VKGraphicsPassEncoder::set_scissor(uint32_t x, uint32_t y, uint32_t width, uint32_t height)
{
    ...
    vk_device->m_device_table.vkCmdSetScissor(vk_command_buffer->m_command_buffer, 0, 1, &scissor);
}
...
void VKGraphicsPassEncoder::set_viewport(float x, float y, float width, float height, float min_depth, float max_depth)
{
    ...
    vk_device->m_device_table.vkCmdSetViewport(vk_command_buffer->m_command_buffer, 0, 1, &viewport);
}
